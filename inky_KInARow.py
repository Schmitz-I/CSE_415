...
class OurAgent(KAgent):
    def __init__(self, twin=False):
        ...
        # Game stats # TODO: Need to return these :sob: 
    ...
    def make_move(self,
        ...
        return [[best_move, new_state,
                ...
                self.zobrist_table_num_hits_this_turn], new_remark]
    ...
    def minimax(self,
        ...
        cutoff_type = None # To be stored in zobrist hash table
        ...
        for i in range(len(successors)):
            child = successors[i]
            move = moves[i]
            child_zhash = self.hash(zhash, child.whose_move, move)
