'''
HocADoo_KInARow.py
Authors: Vuu, Alexander; Schmitz, Ilse; Bui, Elizibeth
  Example:  
...
UWNETIDS = ['inky', 'hocadoo'] # The first UWNetID here should
...
class OurAgent(KAgent):  # Keep the class name "OurAgent" so a game master
    ...
    def __init__(self, twin=False):
        self.twin=twin
        self.nickname = 'HocADoo'
        if twin: self.nickname += '2'
        self.long_name = 'HocADoo'
    ...
    #TODO Make Utterances inteligent based on the state of the board. 
    #make Utterance 
    def GenNextUtterance(self):
    ...
    def make_move(self,
        ...
        nextUtterance = self.GenNextUtterance()
